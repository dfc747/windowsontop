...
class DemoWindowBase:
    ...
    def _RegisterWndClass(self):
        ...
        except (win32gui.error, err_info) as error:
            if error.winerror != winerror.ERROR_CLASS_ALREADY_EXISTS:
                raise
        return className
    ...
    def _SetupList(self):
        ...
        self.hwndList = win32gui.CreateWindow("SysListView32", None, child_style, 0, 0, 100, 100, self.hwnd,
                                              IDC_LISTBOX, self.hinst, None)
    ...
    def OnNotify(self, hwnd, msg, wparam, lparam):
        ...
        if info.code == commctrl.NM_DBLCLK:
            print
            "Double click on item", info.iItem + 1
        return 1
